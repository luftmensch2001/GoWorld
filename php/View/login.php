        ...
        <div class="container__form">
            ...
            <div class="container__form-signup">
                <form method="POST" action="#" class="form-signup__form">
                    <input type="text" class="form-signup__form-username" name="usernameSignup" spellcheck="false" placeholder="Tên đăng nhập">
                    <input type="text" class="form-signup__form-email" name="emailSignup" spellcheck="false" placeholder="Địa chỉ email">
                    <input type="password" class="form-signup__form-password" name="passwordSignup" spellcheck="false" placeholder="Mật khẩu">
                    <input type="password" class="form-signup__form-repassword" name="re-passwordSignup" spellcheck="false" placeholder="Nhập lại mật khẩu">
                </form>
            ...
            <div class="container__form-login">
                <form method="post" action="#"class="form-login__form">
                    <input type="text" class="form-login__form-username" name ="usernameLogin" spellcheck="false" placeholder="Tên đăng nhập">
                    <input type="password" class="form-login__form-password" name ="passwordLogin" spellcheck="false" placeholder="Mật khẩu">
                </form>
                <div>
