...
<body>
    ...
    <form enctype="multipart/form-data" class="container" action="#" method="post" onsubmit="return Check()">
        ...
        <div class="post__info-field">
            ...
            <input type="date" name="dateIn" id="dateIn" class="post__info-input" value="<?php echo $dateIn ?>" required="required">
        </div>
        <div class="post__info-field">
            <p class="post__info-title">Ngày đi</p>
            <input type="date" name="dateOut" id="dateOut" class="post__info-input" value="<?php echo $dateOut ?>" required="required">
        </div>
        <div class="post__info-field">
